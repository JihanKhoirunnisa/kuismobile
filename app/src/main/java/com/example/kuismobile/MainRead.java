...
import com.example.kuismobile.MainRead;
...
public class MainRead extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Mahasiswa cn : contacts) {
            ...
            judulModel.set_angkatan(cn.get_angkatan());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
        ...
        String Sangkatan = obj_itemDetails.get_angkatan();
        Intent goUpdel = new Intent(MainRead.this, MainUpdel.class);
        goUpdel.putExtra("Iid", Sid);
        goUpdel.putExtra("Inama", Snama);
        goUpdel.putExtra("Ijurusan", Sjurusan);
        goUpdel.putExtra("Iangkatan", Sangkatan);
