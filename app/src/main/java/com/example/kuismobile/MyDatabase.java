...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    private static final String tb_mhsiswa_angkatan = "angkatan";
    ...
    public void CreateMahasiswa (Mahasiswa mdNotif) {
        ...
        values.put(tb_mhsiswa_angkatan, mdNotif.get_angkatan());
    ...
    public List<Mahasiswa> ReadMahasiswa() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                mdKontak.set_jurusan(cursor.getString(2));
                mdKontak.set_angkatan(cursor.getString(3));
